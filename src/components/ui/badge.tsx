...
// New badge component for "New" indicators in sidebar  
function NewBadge({
  className,
  children = "New",
  ...props
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center rounded-md bg-chart-1 px-1.5 py-0.5 text-[11px] font-medium text-primary-foreground",
        className
      )}
      {...props}
    >
...
function CountBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center justify-center min-w-[20px] h-5 rounded-md bg-destructive px-1.5 text-[11px] font-medium text-destructive-foreground",
        className
      )}
      {...props}
    >
