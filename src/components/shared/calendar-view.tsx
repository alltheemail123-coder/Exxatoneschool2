...
export function CalendarView({ events = generateCalendarEvents(), onEventClick }: CalendarViewProps) {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'active': return 'bg-chart-3/10 border-chart-3/30 text-chart-3'
      case 'pending': return 'bg-chart-4/10 border-chart-4/30 text-chart-4'
    ...
    <div className="space-y-4">
                    ...
                    {dayEvents.slice(0, 2).map((event) => (
                      <div
                        ...
                        className={cn(
                          ...
                          event.status === 'active' && "bg-chart-3/10 border-l-chart-3 text-chart-3 hover:bg-chart-3/20",
                          event.status === 'pending' && "bg-chart-4/10 border-l-chart-4 text-chart-4 hover:bg-chart-4/20",
      ...
      <div className="flex items-center gap-6 px-1">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-sm bg-chart-3/10 border-l-2 border-l-chart-3"></div>
            <span className="text-sm text-muted-foreground">Available</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-3 h-3 rounded-sm bg-chart-4/10 border-l-2 border-l-chart-4"></div>
